    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>
            All detailed text content has been moved to the <strong>Review Content</strong> tab. 
            This section now only contains structured security settings.
          </AlertDescription>
        </Alert>
        ...
        <div className="space-y-4">
          ...
          {localSecurity.compliance_certifications.length === 0 ? (
