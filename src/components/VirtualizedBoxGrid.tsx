...
import { UnifiedMysteryBoxCard } from './UnifiedMysteryBoxCard';
  ...
  return (
    <UnifiedMysteryBoxCard
      box={{
        ...
        price: box.box_price,
        expected_value_percent: box.expected_value_percent_of_price,
        floor_rate_percent: box.floor_rate_percent,
        volatility_percent: box.standard_deviation_percent,
        provider: box.provider || 'rillabox',
        tags: box.tags,
