...
-- Trigger function to auto-refresh stats
...
-- Create trigger on provider_box_category_overrides
DROP TRIGGER IF EXISTS auto_refresh_category_stats ON provider_box_category_overrides;
CREATE TRIGGER auto_refresh_category_stats
AFTER INSERT OR UPDATE OR DELETE ON provider_box_category_overrides
FOR EACH ROW
EXECUTE FUNCTION trigger_refresh_category_stats();